...
public class MarksPanel extends JPanel {
    ...
    public MarksPanel(){
        ...
        studentId = new JTextField(10); courseId = new JTextField(10); mark = new JTextField(5);
        form.add(new JLabel("Student ID:")); form.add(studentId);
        form.add(new JLabel("Course ID:")); form.add(courseId);
        form.add(new JLabel("Mark:")); form.add(mark);

        JPanel buttons = new JPanel();
        add = new JButton("Add"); view = new JButton("View All"); clear = new JButton("Clear");
        buttons.add(add); buttons.add(view); buttons.add(clear);
    ...
    void addMark(){
        try{
            ...
            ps.setString(1,studentId.getText()); ps.setString(2,courseId.getText()); ps.setInt(3,Integer.parseInt(mark.getText()));
            ps.executeUpdate(); loadMarks(); clearFields();
        } catch(Exception e){ e.printStackTrace(); }
    }
    ...
    void clearFields(){ studentId.setText(""); courseId.setText(""); mark.setText(""); }
